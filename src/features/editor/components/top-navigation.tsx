...
const Tab = ({
    ...
    return (
        <div
            ...
            className={cn(
                "flex items-center gap-2 h-8.75 pl-2 pr-1.5 cursor-pointer text-muted-foreground group border-y border-x  order-transparent hover:bg-accent/30",
                isActive &&
